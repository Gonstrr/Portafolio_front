...
const InfoModal = ({getModalHandler, modalTitle, children}) => {
  ...
  return (
    <Fragment>
      <button class="is-responsive inline-block margin-30 mr-1 px-3 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out" onClick={onButtonClick}>
        Informacion
      </button>
      {modalToggle && (
        <Modal
