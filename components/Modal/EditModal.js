...
const EditModal = ({getModalHandler, postModalHandler, modalTitle, children}) => {
  ...
  return (
    <Fragment>
      <button
        class=" is-responsive inline-block mr-1 px-4 py-2.5 bg-yellow-500 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-yellow-600 hover:shadow-lg focus:bg-yellow-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-yellow-700 active:shadow-lg transition duration-150 ease-in-out"
